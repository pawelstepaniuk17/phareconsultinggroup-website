...
const sections: { heading: string; body: string[] }[] = [
  {
    heading: "1. Publisher",
    body: [
      "This website is published by Phare Consulting Group.",
      "Registered office: 75 Avenue Parmentier, 75011 Paris, France.",
      "Telephone: +33 7 58 92 76 35.",
      "Email: contact@phareconsultinggroup.com.",
    ],
  },
  {
    heading: "2. Hosting",
  ...
  },
  {
    ...
    body: [
      "All content on the site (text, marks, logos, layout, graphic elements and iconography) is protected by copyright and trademark law. Any reproduction, representation, adaptation, translation or distribution, in whole or in part, without Phare Consulting Group’s prior written consent is prohibited.",
      "Short quotations are permitted provided the source (Phare Consulting Group) is clearly cited and a link to the original page is included.",
    ],
  },
  {
    heading: "4. Liability",
    body: [
      ...
      "Phare Consulting Group takes reasonable care to keep information accurate and up to date but does not guarantee that it is complete or free from error. Users remain solely responsible for how they act on it.",
    ],
  },
  {
    heading: "5. Personal data and cookies",
    body: [
      "Personal data collected through the site is described in the privacy policy. Cookies are described in the cookies policy. You may exercise your GDPR rights of access, rectification, erasure, objection, restriction and portability at any time by writing to contact@phareconsultinggroup.com.",
    ],
  },
  {
...
const LegalNotice = () => (
  <SiteLayout>
    <PageHeader
      ...
      title="Legal notice."
      lede="Publisher and hosting information for phareconsultinggroup.com, published under article 6-III of French law n°2004-575 (LCEN)."

...
const AboutPage = () => (
  <SiteLayout>
    <PageHeader
      ...
      lede="Mosaic Conseil is a room in the eleventh, four floors up, that rebuilds plans, deals and org charts once before the meeting they are meant to survive. It works for boards, for chief executives on the ninetieth day, and for the people who will sign the paper on the wall."
